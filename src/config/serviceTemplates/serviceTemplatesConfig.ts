...
export const templatesDefaultConfig = fromJS({
  jsonrpc: '2.0',
...
export const suitesDefaultConfig = fromJS({
  jsonrpc: '2.0',
  method: 'suite.list',
...
export const profilesDefaultConfig = fromJS({
  jsonrpc: '2.0',
  method: 'profile.list',
...
export const dictionariesDefaultConfig = fromJS({
  jsonrpc: '2.0',
